...
class TestTodoList(unittest.TestCase):
    ...
    def test_add(self):
        ...
        self.assertNotEqual(self.todolist.show_todo_list(), [])
    ...
    def test_done(self):
        ...
        self.assertEqual(self.todolist.show_todo_list(), [])
        self.assertNotEqual(self.todolist.show_done_list(), [])
    ...
    def test_show_todo_list(self):
        ...
        self.assertEqual(self.todolist.show_todo_list(), list(reversed(self.events)))
    ...
    def test_show_done_list(self):
        ...
        self.assertEqual(self.todolist.show_done_list(), list(reversed(self.events)))
