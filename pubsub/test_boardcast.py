...
class TestBoardcast(unittest.TestCase):
    ...
    def test_publish(self):
        ...
        self.assertIsNotNone(self.b.listen())

    def test_subscribe(self):
        self.b.publish(self.msg)
        self.assertEqual(self.b.listen(), self.msg)
        print("Sleep one second to test the blocking feature...")
        self.assertIsNone(self.b.listen(1))

    def test_status(self):
        self.assertEqual(self.b.status(), 1)

    def test_close(self):
        self.b.close()
        self.assertEqual(self.b.status(), 0)
