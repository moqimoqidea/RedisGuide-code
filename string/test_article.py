...
class TestArticle(unittest.TestCase):
    ...
    def test_create_works(self):
        self.assertTrue(self.article.create(self.title, self.content, self.author))

        self.assertIsNotNone(self.article.get())
    ...
    def test_get_works(self):
        ...
        self.assertEqual(data["author"], self.author)
        self.assertIsNotNone(data["create_at"])

    def test_create_return_false_when_id_exists(self):
        self.article.create(self.title, self.content, self.author)
        self.assertFalse(self.article.create(self.title, self.content, self.author))
    ...
    def test_update_works(self):
        ...
        self.assertTrue(self.article.update(title=new_title))
    ...
    def test_get_content_len_works(self):
        self.article.create(self.title, self.content, self.author)
        self.assertEqual(len(self.content), self.article.get_content_len())
    ...
    def test_get_content_preview_works(self):
        ...
        self.assertEqual(self.article.get_content_preview(150), long_content[:150])
