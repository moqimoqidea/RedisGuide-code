...
class TestCounter(unittest.TestCase):
    ...
    def test_increase_works(self):
        self.assertEqual(self.counter.increase(), 1)

        self.assertEqual(self.counter.increase(5), 6)

    def test_decrease_works(self):
        self.assertEqual(self.counter.decrease(), -1)

        self.assertEqual(self.counter.decrease(5), -6)
    ...
    def test_reset_works(self):
        ...
        self.assertEqual(self.counter.reset(), 10)
