...
class TestGraph(unittest.TestCase):
    ...
    def test_get_edge_weight(self):
        ...
        self.graph.add_edge("a", "b", 10086)
        self.assertEqual(self.graph.get_edge_weight("a", "b"), "10086")

    def test_add_multi_edges(self):
        self.graph.add_multi_edges(("a", "b", 10), ("b", "c", 20), ("c", "d", 30))
        self.assertEqual(self.graph.get_edge_weight("a", "b"), "10")
        self.assertEqual(self.graph.get_edge_weight("b", "c"), "20")
        self.assertEqual(self.graph.get_edge_weight("c", "d"), "30")
    ...
    def test_get_multi_edge_weights(self):
        ...
        self.assertEqual(e1, "10")
        self.assertEqual(e2, "20")
        self.assertEqual(e3, "30")

    def test_get_all_edges(self):
        self.graph.add_multi_edges(("a", "b", 10), ("b", "c", 20), ("c", "d", 30))

        self.assertEqual(
            self.graph.get_all_edges(), {("a", "b"), ("b", "c"), ("c", "d")}
        )
