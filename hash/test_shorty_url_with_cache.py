...
class TestShortyUrl(unittest.TestCase):
    ...
    def test_shorten_works(self):
        ...
        self.assertEqual(self.shorty_url.restore(short_id), self.url)
    ...
    def test_shorten_cache_works(self):
        ...
        self.assertEqual(first_short_id, second_short_id)

    def test_restore_return_None_when_url_not_exists(self):
        self.assertIsNone(self.shorty_url.restore("10086"))
