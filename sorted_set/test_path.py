...
class TestPath(unittest.TestCase):
    ...
    def test_forward_to(self):
        self.assertEqual(self.path.pagging_record("a", 1, 10), [])
    ...
    def test_pagging_record(self):
        ...
        result = self.path.pagging_record("a", 1, 10)
        self.assertEqual(result, ["d", "c", "b"])

        # more indexing test...
        self.assertEqual(self.path.pagging_record("a", 1, 1)[0], "d")
        self.assertEqual(self.path.pagging_record("a", 2, 1)[0], "c")
