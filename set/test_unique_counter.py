...
class TestUniqueCounter(unittest.TestCase):
    ...
    def test_count_in(self):
        self.assertTrue(self.counter.count_in("a"))
        self.assertFalse(self.counter.count_in("a"))

    def test_get_result(self):
        self.assertEqual(self.counter.get_result(), 0)
        self.counter.count_in("a")
        self.assertEqual(self.counter.get_result(), 1)
