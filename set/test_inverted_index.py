...
class TestInvertedIndex(unittest.TestCase):
    ...
    def test_add_index(self):
        self.assertEqual(self.laptops.get_keywords("MacBook Pro MF840CH"), set())

        self.laptops.add_index("MacBook Pro MF840CH", "Apple", "MacOS", "13.3inch")

        self.assertNotEqual(self.laptops.get_keywords("MacBook Pro MF840CH"), set())
    ...
    def test_get_items(self):
        self.assertEqual(self.laptops.get_items("Apple"), set())
        self.assertEqual(self.laptops.get_items("Apple", "MacOS"), set())
